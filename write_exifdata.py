...
##
## Code to write spnr, genus and species in exif data / xmp tags. Exif information is written in:
        ...
        for name in files:
            if name.endswith((".JPG", ".jpg")):
                ...
                if not os.path.exists(absolutimpath):
                    ...
                    metadata['Xmp.mscbioinf.individualID'] = spnr
...
if len(sys.argv) != 2:
    sys.stderr.write(
        'Usage: write_exifdata.py <path to directory containing .jpg files>\n')
    sys.exit(1)
else:
